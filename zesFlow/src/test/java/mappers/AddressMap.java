...
public class AddressMap {
    ...
    public Elements inputAddress = new Elements(ByValue.ID, "address-search-input-address");
    ...
    public Elements addressType = new Elements(ByValue.ID, "address-details-button-home");
    public Elements seeProducts = new Elements(ByValue.ID, "address-details-button-continue");
    public Elements checkSavedAddress = new Elements(ByValue.CSS, "#delivery-options-card div > div:last-child");
}
